...
calculation = selection['CO2 1000km']/1000*number/174
st.write('Uw CO2 uitstoot door het vliegen voor %s km met de %s is: %s per persoon'%(number, line2, calculation))
