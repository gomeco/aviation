...
new = st.number_input('Insert a number')
calculation = (selection['CO2 1000km']/1000*new/174).to_list()
if calculation != []:
    st.write('Uw CO2 uitstoot door het vliegen voor %s km met de %s is: %s kg CO2 per persoon'%(new, line3, calculation[0]))
...
if selection_passenger and selection_cargo != []:
    st.write('''Uw CO2 uitstoot door het vliegen naar %s is: 
             -Passagier %s kg CO2 per persoon
             -Cargo %s kg CO2 per persoon'''%(line5, selection_passenger[0]*weighted_average_passenger/174, selection_cargo[0]*weighted_average_cargo/174))
