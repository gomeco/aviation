...
calculation = (selection['CO2 1000km']/1000*number2/174).to_list()
if calculation != []:
    st.write('Uw CO2 uitstoot door het vliegen voor %s km met de %s is: %s kg CO2 per persoon'%(number2, line3, calculation[0]))
