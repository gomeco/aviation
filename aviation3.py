...
fig = px.line(air_traffic[air_traffic['Air Transport Movements year']==line2], x="Air Transport Movements month", y=line, color=kleurkeuze
                ,
                #labels={
...
fig = px.bar(movements_main_european[movements_main_intercontinental['country']==line],x='country', y='total_movements', color='country',
                #labels={
                 #        "salary_in_euro": "Salaris in Euro",
                  #       "experience_level": "Werkervaring"
                   #  },
