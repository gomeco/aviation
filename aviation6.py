...
if options == []:
    ...
    fig = px.bar(movements_main_european[movements_main_european['country'].isin(options)],x='country', y='total_movements', color='country',
                #labels={
                 #        "salary_in_euro": "Salaris in Euro",
                  #       "experience_level": "Werkervaring"
                   #  },
...
if options == []:
    ...
    fig = px.bar(movements_main_intercontinental[movements_main_intercontinental['country'].isin(options)],x='country', y='total_movements', color='country',
                    #labels={
                     #        "salary_in_euro": "Salaris in Euro",
                      #       "experience_level": "Werkervaring"
                       #  },
...
if options == []:
    ...
    fig = px.bar(aircraf_movements_passenger_mixed[aircraf_movements_passenger_mixed['type'].isin(options)],x='type', y='total_movements', color='type',
                    #labels={
                     #        "salary_in_euro": "Salaris in Euro",
                      #       "experience_level": "Werkervaring"
                       #  },
...
if options == []:
    ...
    fig = px.bar(aircraft_movements_cargo[aircraft_movements_cargo['type'].isin(options)],x='type', y='total_movements', color='type',
                    #labels={
                     #        "salary_in_euro": "Salaris in Euro",
                      #       "experience_level": "Werkervaring"
                       #  },
...
if options == []:
    ...
    fig = px.bar(movements_main_airlines[movements_main_airlines['airline'].isin(options)],x='airline', y='total', color='airline',
                   #labels={
                    #        "salary_in_euro": "Salaris in Euro",
                     #       "experience_level": "Werkervaring"                       #  },
                      title="Grafiek voor %s"%(options))
...
if options == []:
    ...
    fig = px.bar(aircraf_movements_passenger_mixed[aircraf_movements_passenger_mixed['type'].isin(options)],x='type', y='CO2 1000km', color='type',
                    #labels={
                     #        "salary_in_euro": "Salaris in Euro",
                      #       "experience_level": "Werkervaring"
                       #  },
